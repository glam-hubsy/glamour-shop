...
export default function SplashScreen() {
  ...
  return (
    ...
    >
      {/* Decorative circles */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-pink-600/20 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-pink-400/10 rounded-full blur-2xl" />
      ...
      <div className="relative flex flex-col items-center gap-6">
        ...
        <div className="text-center">
          <p className="text-pink-300 text-lg font-light tracking-widest">أهلاً بك</p>
        ...
        <div className="w-48 h-0.5 bg-gray-700 rounded-full overflow-hidden mt-4">
          <div className="h-full bg-[#e91e8c] rounded-full animate-[loading_2.4s_ease-in-out_forwards]" />
        </div>
      </div>
