...
const brands = [
  {
    ...
    color: "from-purple-600/70 to-rose-500/50",
    image: "/brands/love-generation.jpg",
  ...
  },
  {
    ...
    color: "from-teal-900/80 to-cyan-800/60",
    image: "/brands/beauty-bomb.jpg",
    textColor: "text-cyan-200",
    accentColor: "bg-[#e91e8c]",
  },
  {
    name: "Stellary",
    name_ar: "ستيلاري",
    tagline_en: "A touch of luxury for the modern woman 🌟",
    tagline_ar: "لمسة فخامة للمرأة العصرية 🌟",
    color: "from-black/80 to-stone-900/60",
    image: "/brands/stellary.jpg",
